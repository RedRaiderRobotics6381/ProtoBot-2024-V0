...
public class ArmSubsystem extends SubsystemBase {
    ...
    //public SparkMaxAbsoluteEncoder wristRotateEncoder; //Changed to SparkAbsoluteEncoder in 2024?
    public SparkAbsoluteEncoder wristRotateEncoder;
    ...
    public ArmSubsystem() {
        ...
        wristRotateEncoder = wristRotateMotor.getAbsoluteEncoder(SparkAbsoluteEncoder.Type.kDutyCycle); //Changed from SparkAbsoluteEncoder, This is for 2024. 
